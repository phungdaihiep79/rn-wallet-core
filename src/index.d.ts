...
export class TransactionCompiler {
  ...
  static preImageHashes(
    coinType: CoinType,
    txInputData: Uint8Array | Buffer
  ): Uint8Array;
  static compileWithSignatures(
    coinType: CoinType,
    txInputData: Uint8Array | Buffer,
    signatures: DataVector,
    publicKeys: DataVector
  ): Uint8Array;
}
...
export class HDWallet {
  static getPublicKeyFromExtended(
    extended: string,
    coin: CoinType,
  ...
  static createWithMnemonicCheck(
    mnemonic: string,
    passphrase: string,
    check: boolean
  ): HDWallet;
  static createWithEntropy(
...
export class StoredKey {
  ...
  static createLevel(
    name: string,
    password: Uint8Array | Buffer,
    encryptionLevel: StoredKeyEncryptionLevel
  ): StoredKey;
...
export class EthereumAbi {
  ...
  static decodeOutput(
    fn: EthereumAbiFunction,
    encoded: Uint8Array | Buffer
  ): boolean;
...
export class BitcoinScript {
  ...
  static buildPayToWitnessScriptHash(
    scriptHash: Uint8Array | Buffer
  ): BitcoinScript;
